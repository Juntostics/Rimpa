//
//  HorizontalPosterViewController.m
//  Rimpa!
//
...
@implementation HorizontalPosterViewController
...
- (void)viewDidLoad
{
    ...
    abGridView.itemSize = CGSizeMake(335, 240);
...
{
    return [images.horizontalPosterImages count];
}
...
- (UIView *)viewForItemInGridViewAtImageView:(ABGridView *)gridView atIndex:(NSInteger)index
{
    ...
    item.image = images.horizontalPosterImages[index];
